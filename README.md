...
5. Resource ID 可选：
   - `volc.bigasr.sauc.duration` - 大模型 1.0 小时版
   - `volc.bigasr.sauc.concurrent` - 大模型 1.0 并发版
   - `volc.seedasr.sauc.duration` - 大模型 2.0 小时版 (推荐)
   - `volc.seedasr.sauc.concurrent` - 大模型 2.0 并发版
