...
async function invokeIpc(channel: string): Promise<unknown> {
  // Phase 1 stub — window controls not wired yet
  console.log('[ClawDesk] invokeIpc stub:', channel);
  return undefined;
}
...
export function TitleBar() {
  if (platform === 'darwin') {
    ...
    return <div className="drag-region h-10 shrink-0 border-b border-border bg-background" />;
  }
...
function WindowsTitleBar() {
  ...
  return (
    <div className="drag-region flex h-10 shrink-0 items-center justify-end border-b border-border bg-background">
